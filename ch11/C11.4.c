...
void print_result(bool *staight, bool *flush, bool *four, bool *three, int *pairs);
...
int main(int argc, const char * argv[]) {
    ...
    for(;;)
    {
        ...
        analyze_hand(num_in_rank,num_in_suits,&straight,&flush,&four,&three,&pairs);
...
void analyze_hand(int num_in_rank[],int num_in_suits[], bool *straight, bool *flush, bool *four, bool *three, int *pairs)
{
    ...
    *pairs= 0;
    ...
    /* check for ace-low ("wheel") straight: A 2 3 4 5 */
    else if(num_in_rank[0]==1 && num_in_rank[1]==1 && num_in_rank[2]==1 && num_in_rank[3]==1 && num_in_rank[12]==1)
    {
        *straight=true;
        return;
    }
